...
export const resRecommendDj = () => ajax(BASE_URL + '/dj/recommend')
export const resPayGift = () => ajax(BASE_URL + '/dj/paygift')
export const resRadioCategory = () => ajax(BASE_URL + '/dj/catelist')
export const resRadioCategoryRecommend = (type) => ajax(BASE_URL + '/dj/recommend/type', {'type': type})
